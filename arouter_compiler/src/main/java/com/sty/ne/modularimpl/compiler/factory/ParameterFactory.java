package com.sty.ne.modularimpl.compiler.factory;
...
/**
 * @Author: tian
 * @UpdateDate: 2020/10/30 10:18 PM
 */
public class ParameterFactory {
    ...
    public void addFirstStatement() {
        //方法体内容：MainActivity t = (MainActivity) target;
    ...
    /**
     * 构建方法体中循环内容，如：t.s = t.getIntent().getStringExtra("s");
    ...
    public void buildStatement(Element element) {
        ...
        if(type == TypeKind.INT.ordinal()) {
            ...
            //t.s = t.getIntent.getBooleanExtra("isSuccess", t.isSuccess);
    ...
    public static class Builder{
        ...
        public ParameterFactory build() {
            ...
            if(messager == null) {
                throw new IllegalArgumentException("messager为空，Messager用来报告错误、警告和其它提示信息");
            }
